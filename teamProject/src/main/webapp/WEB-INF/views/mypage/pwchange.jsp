...
<body>
<form action="pwchk" method="post" name="pwchk">
<h2>현재 비밀번호를 입력해주세요</h2>
<input type="hidden" name="bpwchk" value="${sessionScope.buyer_pw}"/>
<input type="password" name="beforepw"/>
<h2>바꾸고자 하는 비밀번호를 입력해주세요</h2>
<input type="password" name="afterpw"/>
<h2>바꾸고자 하는 비밀번호를 한번 더 입력해주세요</h2>
